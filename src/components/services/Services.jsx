...
const Services = () => {
    const [toggleSetate, setToggleState] = useState(0);
        ...
        <section className='services section' id="services">
            ...
            <div className="services_container grid">
                ...
                <div className="services_content">
                    ...
                    <div className={toggleSetate === 1 ? "services_modal active-modal" : "services_modal"}>
                ...
                <div className="services_content">
                    ...
                    <div className={toggleSetate === 2 ? "services_modal active-modal" : "services_modal"}>
                        <div className="services_modal-content">
                            <i onClick={() => toggleTab(0)} className="uil uil-times services_modal-close"></i>
                ...
                <div className="services_content">
                    ...
                    <div className={toggleSetate === 3 ? "services_modal active-modal" : "services_modal"}>
                        <div className="services_modal-content">
                            <i onClick={() => toggleTab(0)} className="uil uil-times services_modal-close"></i>
