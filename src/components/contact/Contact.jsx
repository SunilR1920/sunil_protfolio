                ...
                <div className='contact_contact'>
                    ...
                    <div className='contact_info'>
                        <div className="contact_card">
                            ...
                            <span className='contact_card-data'>sunilrathod.spri@gmail.com</span>
                        ...
                        <div className="contact_card">
                            ...
                            <span className='contact_card-data'>9970533222</span>

                            <a href="https://api.whatsapp.com/send?phone=9970533222&text=Hello, more information!" className='contact_button'>Write me{" "}
                                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
                            </a>
                        </div>
